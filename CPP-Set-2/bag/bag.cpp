// Editor:      Nick Seyler
// Date:        2/18/17
// Description: File to practice reading other's code. bag.h and bag.cpp are files that were provided, but everything inside of namespace main_savitch_4 in bag.cpp was created by Nick Seyler.
